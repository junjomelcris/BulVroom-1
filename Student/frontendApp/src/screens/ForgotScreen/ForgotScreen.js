...
const ForgotScreen = () => {
  ...
  return (
    ...
    <View style={styles.div1}>
     ...
     <View style={styles.div1}>
      <Text style={styles.frgt}>Forgot your Password?</Text>
     </View>
     <View style={styles.div2}>
      <Text style={styles.frgtdeets}>Enter your registered Email and we'll send you  {'\n'} 
      a code to reset your password</Text>
     </View>
     <TextInput
        style={styles.input}
